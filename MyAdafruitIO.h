...
#define IO_USERNAME       "SeptembreAlexandre"
#define IO_KEY            "720b7c20343440908b600610d7ebe68f"
// Feeds
...
void getAndSendDataToAdafruit(){
  ...
  //float myRandomHum = 50+(float)random(-100,100)/10;
      ...
      MYDEBUG_PRINTLN("--- avant");  // Envoi des données au Broker
    MYDEBUG_PRINTLN("--- après");  // Envoi des données au Broker
      MYDEBUG_PRINTLN(tempe);
  temperatureFeed.publish(tempe);
}
